        ...
        <section className="hero">
          <div className="container">
            <div className="hero-content">
              ...
              <p>Интеллектуальный бот, который адаптируется под ваши материалы и помогает учиться эффективнее
                прямо в Telegram!
              </p>
              <p>
              ...
              <p className='hero-content_descr'>
                Просто отправьте боту учебный материал, а потом спокойно ешьте бутерброд — он уже трудится над понятными объяснениями и чек-листами.
              </p>
